...
def isis_config(task):
    data = task.host.data
    net_response = task.run(task=pyez_config, template_path='/Users/aramide/PycharmProjects/NornirJunos/isis_interfaces.j2',
    ...
    response = task.run(task=pyez_config, template_path='/Users/aramide/PycharmProjects/NornirJunos/isis_config.j2',
